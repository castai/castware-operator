...
// Source: github.com/castai/castware-operator/internal/helm (interfaces: ChartLoader)
...
import (
	...
	helm "github.com/castai/castware-operator/internal/helm"
...
func (m *MockChartLoader) Load(arg0 context.Context, arg1 *helm.ChartSource) (*chart.Chart, error) {
	m.ctrl.T.Helper()
